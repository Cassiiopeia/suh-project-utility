...
import me.suhsaechan.suhprojectutility.service.DockerLogService;
...
public class DockerLogController {
    ...
    public SseEmitter streamContainerLogs(@ModelAttribute DockerLogRequest request) {
    ...
    public ResponseEntity<String> stopContainerLogs(@ModelAttribute DockerLogRequest request) {
        String containerName = request.getContainerName() != null ? request.getContainerName() : "sejong-malsami-back";
    ...
    public ResponseEntity<String> clearContainerLogs(@ModelAttribute DockerLogRequest request) {
        String containerName = request.getContainerName() != null ? request.getContainerName() : "sejong-malsami-back";
