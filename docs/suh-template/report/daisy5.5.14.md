...
BLUEPRINT
 The Official daisyUI Code Generator  MCP Server
5.5.14 
유틸리티 클래스과 CSS 변수
daisyUI는 라이브러리를 보다 효과적으로 사용할 수 있도록 몇 가지 유용한 유틸리티 클래스와 CSS 변수를 제공합니다.
...
Customizing --alert-color using a utility class:

html
<div class="alert [--alert-color:blue]">
  <span>12 unread messages. Tap to see.</span>
</div>
Customizing --alert-color from CSS:
...
질문이 있으신가요? Ask on GitHub or Discord server
버그를 발견하셨나요? GitHub에서 이슈 열기
daisyUI가 마음에 드시나요? Post about it!
daisyUI 개발 지원: Open Collective
GitHub에서 이 페이지 수정하기
...
ads via Carbon
Wispr Flow is developer-first dictation: precise, context-aware, and 4x faster than typing.
ads via Carbon
유틸리티 클래스과 CSS 변수 — daisyUI Tailwind CSS Component UI Library